...
class TwoThread implements Runnable {
    ...
    @Override
    public void run() {
        System.out.println("Implementation of Runnable interface : " + Thread.currentThread().getName());
    }
}
...
class ThreeThread implements Callable<Integer> {
    ...
    @Override
    public Integer call() {
        System.out.println("Implementation of callable interface : " + Thread.currentThread().getName());
        return 1;
    }
}
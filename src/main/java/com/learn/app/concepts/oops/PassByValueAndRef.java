...
public class PassByValueAndRef {
    ...
    public void changePassByValueTest(Employee emp) {
        ...
        // Though we are assigning emp to a new object but, it will not change that ---- Java is pass by value
    ...
    public void changePassByRefTest(Employee emp) {
        ...
        // Here, if we are changing ref. attribute inside incoming object hence, it will impact actual object
        emp.setName("Cow Boy");
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Though called method assigned a new object to passing object but, still its unchanged : After Change- "+ sample1);
        ...
        System.out.println("Called and changed a attribute ref. in calling method.... Its should change. : After Change- "+ sample2);
    }

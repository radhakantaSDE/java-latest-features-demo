...
public class DCompletableFutureCompositionOperation {
    ...
    public void testAllOf() {
        ...
        CompletableFuture<String> one = CompletableFuture.supplyAsync(() -> {
            System.out.println("One. Thread: "+ Thread.currentThread().getName());return "One Task";});
        CompletableFuture<String> two = CompletableFuture.supplyAsync(() -> {
            ...
            return "Two Task";});
        CompletableFuture<String> three = CompletableFuture.supplyAsync(() -> {System.out.println("Three. Thread: "+ Thread.currentThread().getName());return "Three Task";});

        CompletableFuture<Void> all =CompletableFuture.allOf(one, two, three).thenRun(() -> {
            System.out.println("All tasks completed successfully.");
            System.out.println("Results: "+ one.join() + ", " + two.join() + ", " + three.join());
        });
    ...
    public void testAnyOf() {
        ...
        CompletableFuture<Void> any = CompletableFuture.anyOf(one, two, three).thenAccept(result -> {
...
//        operation.testAllOf();
        ...
        operation.testAnyOf();
        System.out.println("************************ Completed: CompletableFuture.anyOf() *****************");

...
public class BCompletableFutureSupplyAsyncOperation {
    ...
    public void supplyAsyncOperation() {
        CompletableFuture<Integer> completableFuture = CompletableFuture.supplyAsync(() -> {
            try {
                ...
                System.err.println("Error occurred during asynchronous operation: " + e.getMessage());
            }
            return 100;
        });
        try {
        ...
        try(ExecutorService executorService = Executors.newFixedThreadPool(3)) {
            CompletableFuture<Integer> completableFuture = CompletableFuture.supplyAsync(() -> {
                try {
                    ...
                    System.out.println("Error occurred during asynchronous operation: " + e.getMessage());
                }
                return 1000;
            }, executorService);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("************************ Ex-2: SupplyAsync with custom executor *****************");

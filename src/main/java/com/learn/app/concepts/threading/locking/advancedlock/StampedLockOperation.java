...
public class StampedLockOperation {
    ...
    public void writeConfig(String key, String value) {
        ...
        try {
            ...
            System.out.println("Config written: " + key + " = " + value + " by Thread: " + Thread.currentThread().getName());
        }finally {
    ...
    public String getConfig(String key) {
        ...
        if (stampedLock.validate(stamp)) {
            ...
            System.out.println("Config read: " + key + " = " + value + " by Thread: " + Thread.currentThread().getName());
            return value;
        } else {
            stamp = stampedLock.readLock();
            try {
                String value = configMap.get(key);
                System.out.println("Config read (after acquiring read lock): " + key + " = " + value + " by Thread: " + Thread.currentThread().getName());
                return value;
            } finally {
